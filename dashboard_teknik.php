...
<head>
    ...
    <title>Dashboard Teknik - Komunikasi Manager</title>
    ...
    <script>
        ...
        function loadKendala() {
            ...
            $.get("fetch_kendala.php", function(data) {
                ...
                // 🔥 Update statistik setelah tabel diperbarui
                updateStats();
            });
        }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="top-actions">
            ...
            <a href="riwayat_kendala.php" class="action-btn">
                ...
                <table id="mainTable">
                    <thead>
                        <tr>
                            ...
                            <th><i class="fas fa-users"></i> Unit Tujuan</th>
                    ...
                    <tbody id="tabel-kendala">
                        <?php while ($row = $result->fetch_assoc()): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="GET" action="update_unit.php" style="display: flex; gap: 5px; align-items: center;">
                                        <input type="hidden" name="id" value="<?= $row['id'] ?>">
                                        <select name="unit">
