<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] != 'navigasi') {
...
<head>
    ...
    <title>Dashboard Navigasi - Komunikasi Manager</title>
    ...
    <script>
        ...
        function loadKendala() {
            ...
            $.get("fetch_kendala_navigasi.php", function(data) {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="top-actions">
            ...
            <a href="riwayat_kendala navigasi.php" class="action-btn">
    ...
    <div id="tanggapanModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="tambah_tanggapan navigasi.php">
