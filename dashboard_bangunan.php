<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] != 'bangunan') {
...
$today = date('Y-m-d');
$result = $conn->query("SELECT * FROM kendala WHERE DATE(waktu) = '$today' AND unit='bangunan' ORDER BY waktu DESC");
?>
...
<head>
    ...
    <title>Dashboard Bangunan - Komunikasi Manager</title>
    ...
    <script>
        ...
        function loadKendala() {
            ...
            $.get("fetch_kendala_bangunan.php", function(data) {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="top-actions">
            ...
            <a href="riwayat_kendala bangunan.php" class="action-btn">
    ...
    <div id="tanggapanModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="tambah_tanggapan bangunan.php">
