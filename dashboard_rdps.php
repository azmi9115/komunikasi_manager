<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] != 'rdps') {
...
$today = date('Y-m-d');
$result = $conn->query("SELECT * FROM kendala WHERE DATE(waktu) = '$today' AND unit='rdps' ORDER BY waktu DESC");
?>
...
<head>
    ...
    <title>Dashboard Flight Plan Data and Radar Data Processing Systems - Komunikasi Manager</title>
    ...
    <script>
        ...
        function loadKendala() {
            ...
            $.get("fetch_kendala_rdps.php", function(data) {
...
<body>
    ...
    <div class="header">
        <div class="header-content">
            <div class="header-title">
                ...
                <h1>Dashboard Flight Plan Data and Radar Data Processing Systems</h1>
            </div>
    ...
    <div class="main-content">
        ...
        <div class="top-actions">
            ...
            <a href="riwayat_kendala rdps.php" class="action-btn">
    ...
    <div id="tanggapanModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="tambah_tanggapan rdps.php">
