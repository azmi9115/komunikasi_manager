...
<head>
    ...
    <script>
        ...
        function exportData() {
            ...
            if (startDate) {
                window.open(`export_excel.php?start=${startDate}`, '_blank');
...
<body>
    <div class="container">
        ...
        <?php if ($_SESSION['role'] == 'teknik'): ?>
            <a href="dashboard_teknik.php" class="button">⬅️ Kembali ke Dashboard</a>
        <?php else: ?>
            <a href="dashboard_ops.php" class="button">⬅️ Kembali ke Dashboard</a>
        <?php endif; ?>
