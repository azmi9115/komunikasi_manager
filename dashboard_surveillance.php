<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] != 'surveillance') {
...
$today = date('Y-m-d');
$result = $conn->query("SELECT * FROM kendala WHERE DATE(waktu) = '$today' AND unit='surveillance' ORDER BY waktu DESC");
?>
...
<head>
    ...
    <title>Dashboard Surveillance - Komunikasi Manager</title>
    ...
    <script>
        ...
        function loadKendala() {
            ...
            $.get("fetch_kendala_surveillance.php", function(data) {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="top-actions">
            ...
            <a href="riwayat_kendala surveillance.php" class="action-btn">
    ...
    <div id="tanggapanModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="tambah_tanggapan surveillance.php">
