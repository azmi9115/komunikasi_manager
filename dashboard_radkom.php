<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] != 'radkom') {
...
$today = date('Y-m-d');
$result = $conn->query("SELECT * FROM kendala WHERE DATE(waktu) = '$today' AND unit='radkom' ORDER BY waktu DESC");
?>
...
<head>
    ...
    <title>Dashboard Radio Komunikasi - Komunikasi Manager</title>
    ...
    <script>
        ...
        function loadKendala() {
            ...
            $.get("fetch_kendala_radkom.php", function(data) {
...
<body>
    ...
    <div class="header">
        <div class="header-content">
            <div class="header-title">
                ...
                <h1>Dashboard Radio Komunikasi</h1>
            </div>
    ...
    <div class="main-content">
        ...
        <div class="top-actions">
            ...
            <a href="riwayat_kendala radkom.php" class="action-btn">
    ...
    <div id="tanggapanModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="tambah_tanggapan radkom.php">
