<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] != 'amss') {
...
$today = date('Y-m-d');
$result = $conn->query("SELECT * FROM kendala WHERE DATE(waktu) = '$today' AND unit='amss' ORDER BY waktu DESC");
?>
...
<head>
    ...
    <title>Dashboard Automatic Message Switching System  - Komunikasi Manager</title>
    ...
    <script>
        ...
        function loadKendala() {
            ...
            $.get("fetch_kendala_amss.php", function(data) {
...
<body>
    ...
    <div class="header">
        <div class="header-content">
            <div class="header-title">
                ...
                <h1>Dashboard Automatic Message Switching System</h1>
            </div>
    ...
    <div class="main-content">
        ...
        <div class="top-actions">
            ...
            <a href="riwayat_kendala amss.php" class="action-btn">
    ...
    <div id="tanggapanModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="tambah_tanggapan amss.php">
